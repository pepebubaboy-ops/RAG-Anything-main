...
def get_processor_for_type(modal_processors: Dict[str, Any], content_type: str):
    ...
    """
    # Direct mapping to corresponding processor with generic fallback.
    # This keeps processing resilient when a specific modality processor
    # is disabled in config (e.g., image processor disabled).
    if content_type == "image":
        return modal_processors.get("image") or modal_processors.get("generic")
    elif content_type == "table":
        return modal_processors.get("table") or modal_processors.get("generic")
    elif content_type == "equation":
        return modal_processors.get("equation") or modal_processors.get("generic")
    else:
